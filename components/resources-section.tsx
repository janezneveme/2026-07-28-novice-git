          ...
          <Tabs defaultValue="legislation" className="space-y-4">
            ...
            <TabsContent value="legislation" className="mt-0">
              ...
              <p className="text-xs text-muted-foreground mt-4 pt-4 border-t border-border">
                {lang === "sl" 
                  ? "Vir: Društvo novinarjev Slovenije (novinar.com)" 
                  : "Source: Association of Journalists of Slovenia (novinar.com)"}
              </p>
            </TabsContent>
            ...
            <TabsContent value="tools" className="mt-0">
              ...
              <p className="text-xs text-muted-foreground mt-4 pt-4 border-t border-border">
                {lang === "sl" 
                  ? "Orodja za analizo medijske pristranskosti in zanesljivosti informacij" 
                  : "Tools for analyzing media bias and information reliability"}
              </p>
            </TabsContent>
          </Tabs>
        </CardContent>
