        ...
        <CardContent className="p-6">
          <Tabs defaultValue="bias" className="space-y-6">
            <TabsList className="grid w-full grid-cols-3 bg-muted/50">
              <TabsTrigger value="bias">{t.biasTab}</TabsTrigger>
              <TabsTrigger value="reliability">{t.reliabilityTab}</TabsTrigger>
              <TabsTrigger value="sources">{t.sourcesTab}</TabsTrigger>
            </TabsList>
