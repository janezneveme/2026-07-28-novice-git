        ...
        <div className="flex items-center gap-2">
          ...
          <Select value={sortField} onValueChange={(v) => setSortField(v as SortField)}>
            ...
            <SelectContent>
              ...
              <SelectItem value="bias">{t.bias}</SelectItem>
              <SelectItem value="reliability">{t.reliability}</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-muted/50">
              ...
              <TableHead className="hidden md:table-cell font-semibold">{t.type}</TableHead>
              <TableHead className="hidden lg:table-cell font-semibold">{t.owner}</TableHead>
          ...
          <TableBody>
            {sortedData.map((media) => (
              ...
              >
                ...
                <TableCell className="hidden lg:table-cell text-muted-foreground text-sm truncate max-w-[150px]">
                  {media.owner}
                </TableCell>
