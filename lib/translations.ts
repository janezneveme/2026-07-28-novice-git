...
export const translations = {
  sl: {
    ...
    biasExplanation: "Ocene politične pristranskosti temeljijo na analizi uredniških stališč, izbire gostov, okvirjanja zgodb in jezikovnih vzorcev. Ocene segajo od -1 (močno levo) do +1 (močno desno), pri čemer 0 predstavlja rijk poročanje. Viri vključujejo akademske raziskave in organizacije za preverjanje dejstev.",
    contentTypeExplanation: "Informativni mediji",
    contentTypeExplanationNews: "Mediji, ki se osredotočajo na poročanje o dejstvih in novicah. Zanesljivost se meri po natančnosti podatkov, kakovosti virov in ločevanju novic od mnenj.",
    contentTypeExplanationOpinion: "Mediji ali sekcije s poudarkom na mnenju, analizi in komentarjih. Zanesljivost se tukaj nanaša na to, kako temeljijo mnenja na realnih ali nerealnih podatkih ter ali avtorji ustrezno razlikujejo med dejstvi in mnenji.",
